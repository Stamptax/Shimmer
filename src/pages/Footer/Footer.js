            ...
            <div className='footer-wrapper'>
                ...
                <div className='contact-instantly'>
                    ...
                    <div className='contact-info'>
                        <a className='contact-media' href='tel:+861817367097'>Phone number: +86 181 7367 9097</a>
                        <a className='contact-media' href='mailto:18173679097@outlook.com'>Email: 18173679097@outlook.com</a>
                        <a className='contact-media' href="https://www.xiaohongshu.com/user/profile/5db954080000000001005d07">Xiaohongshu: Shimmer-微光</a>
                        <div className='wechat-icon'><span className='wechat-id'>WeChat ID: shimmer---007</span> </div>
                    </div>
                </div>
